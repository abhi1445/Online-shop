    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3> Brown Bunny Tails Naturally Dried Flower</h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">1775</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">1775</span></b></p>
            </div><br>
