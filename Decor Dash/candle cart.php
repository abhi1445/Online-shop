    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Ivory Gold Plated Scented Candles</h3><br>
            <div class="price">
              <p>Price Per Candle Set : Rs. <span class="ticket_price">400</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">400</span></b></p>
            </div><br>
