    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Elephant Round Transparent Glass Jar Set</h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">2198</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">2198</span></b></p>
            </div><br>
