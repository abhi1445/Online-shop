    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Chrono Aluminium Decorative Golden Table Clock</h3><br>
            <div class="price">
              <p>Price Per Clock : Rs. <span class="ticket_price">1689</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">1689</span></b></p>
            </div><br>
