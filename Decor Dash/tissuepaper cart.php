    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Wooden Holder For Napkin & Tissue Paper</h3><br>
            <div class="price">
              <p>Price Per Holder : Rs. <span class="ticket_price">598</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">598</span></b></p>
            </div><br>
