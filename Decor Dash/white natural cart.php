    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3> White and Brown Natural Dried Pampas Grass</h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">945</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">945</span></b></p>
            </div><br>
