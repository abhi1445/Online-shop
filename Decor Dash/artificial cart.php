    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3> Beautiful Artificial Eucalyptus Leaf Stem For vase  </h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">587</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">587</span></b></p>
            </div><br>
