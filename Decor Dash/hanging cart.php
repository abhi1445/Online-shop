    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Decorative Hanging Butterfly Tealight</h3><br>
            <div class="price">
              <p>Price Per Hanging Set : Rs. <span class="ticket_price">436</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">436</span></b></p>
            </div><br>
