    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Golden Metal Framed Full Length Rectangular</h3><br>
            <div class="price">
              <p>Price Per Mirror : Rs. <span class="ticket_price">2770</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">2770</span></b></p>
            </div><br>
            ...
            <button style="border-radius: 5px; font-size: 25px;color: black;padding-left: 5px; 
            padding-right: 5px;padding-top: 5px;padding-bottom: 5px;" class="btn"><a href="orderplaced.php" style="color:black;">Buy Now</a></button>
            </div>
