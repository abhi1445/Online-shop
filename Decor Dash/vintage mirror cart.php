    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Vintage Brown Aluminium Wall Mirror</h3><br>
            <div class="price">
              <p>Price Per Mirror : Rs. <span class="ticket_price">1770</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">1770</span></b></p>
            </div><br>
