    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Ajmeri Brass Fumer With Tong Golden Dhoop For Pooja</h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">1530</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">1530</span></b></p>
            </div><br>
