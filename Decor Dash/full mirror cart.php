    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Full Length Rectangular Floor Mirror</h3><br>
            <div class="price">
              <p>Price Per Mirror : Rs. <span class="ticket_price">7995</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">7995</span></b></p>
            </div><br>
