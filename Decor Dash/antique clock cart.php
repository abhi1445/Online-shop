    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Antique Black Metal Modern Sitting Man Decor</h3><br>
            <div class="price">
              <p>Price Per Clock : Rs. <span class="ticket_price">2488</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">2488</span></b></p>
            </div><br>
