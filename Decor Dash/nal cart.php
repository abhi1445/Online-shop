    ...
    <div class="banner">
        <div class="wrapper">
           ...
           <form action="#" style="color: white;font-size: 20px;">
            <h3>Luxurious Aluminium Nal Indoor Planter</h3><br>
            <div class="price">
              <p>Price Per Decor : Rs. <span class="ticket_price">2783</span></p><br>
              <p>Subtotal : <b>Rs. <span class="total">2783</span></b></p>
            </div><br>
